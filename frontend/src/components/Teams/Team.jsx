                ...
                <div className="container">
                    <div className="row team-title" style={{marginTop: 2 + "em"}}>
                        <div className="col s4">
                            <img src={process.env.PUBLIC_URL + '/images/default-team.jpg'} alt="Team Logo" />
                        </div>
                            ...
                            <div className="row">
                                <div className="col s12">
                                    <div className="card-panel" style={{float: "left"}}>
                                        <h3 style={{marginTop: 0}}>Team Roster</h3>
                                        <hr />
                        ...
                        <div className="col s4">
                            <div>
                                <div className="row">
                                    <div className="col s12">
                                        <div className="card-panel">
                                            <h5 style={{marginTop: 0}}>About Team Secret</h5>
                                            <hr />
                                            <p>Team ID: 2</p>
